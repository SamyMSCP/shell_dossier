	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content" style="background-color:#EBEBEB">
			<div class="modal-header" style="margin-top: 10px;">
				...
				<h4 class="modal-title">UNE SCPI DÉTENUE PAR CE CLIENT</h4>
			</div>
			<div class="traitOrange"></div>
			<div class="modal-body">
				<form class="form-horizontal formAddNewScpi" method="POST" action="?p=EditionClient&client=<?=$GLOBALS['GET']['client']?>">
					<input type="hidden" name="token" id="token" value="<?php echo $_SESSION['csrf'][0]; ?>"/>
					<fieldset>

						<!-- Select Basic -->
						<div class="form-group">
							<label class="col-md-4 control-label" for="SCPI"><img src="<?=$this->getPath()?>img/tooltip.ico" onmouseover="display_tooltip('Nom de la SCPI', 'Sélectionner votre SCPI')" onmouseout="disable_msg(event)" style="width: 20px;"> Nom de la SCPI ? *</label>
							<div class="col-md-4">
						...
						<!-- Text input-->
						<div class="form-group">
							<label class="col-md-4 control-label" for="part"><img src="<?=$this->getPath()?>img/tooltip.ico" onmouseover="display_tooltip('Nombre de parts achetées', 'Nombre de parts souscrit dans la SCPI')" onmouseout="disable_msg(event)" style="width: 20px;"> Nombre de parts achetées *</label>
							<div class="col-md-4">
								<input id="part" name="part" type="text" placeholder="Nombre de part" class="form-control input-md" required="">
							</div>
							<img class="valid2" src="<?=$this->getPath()?>img/valid.png"> <img class="erreur2" src="<?=$this->getPath()?>img/warning.ico">
						</div>
						<!-- Select Basic -->
						<div class="form-group">
							<label class="col-md-4 control-label" for="propriete"><img src="<?=$this->getPath()?>img/tooltip.ico" onmouseover="display_tooltip('Type de propriété', 'Sélectionner le type de propriété')" onmouseout="disable_msg(event)" style="width: 20px;"> Type de propriété</label>
							<div class="col-md-4">
						...
						<div id="moredtl">
							...
							<div class="form-group">
								<label class="col-md-4 control-label" for="cle">Clé de répartition %</label>	
								<div class="col-md-4">
									<input id="cle" name="cle" type="text" placeholder="" class="form-control input-md">
								</div>
								<img class="valid1" src="<?=$this->getPath()?>img/valid.png"><img class="erreur1" src="<?=$this->getPath()?>img/warning.ico">
							</div>
							
							<div class="form-group">
								<label class="col-md-4 control-label">Type de démembrement</label>	
								<div class="col-md-4">
							...
							<div class="form-group" id="demembrement">
								<label class="col-md-4 control-label" for="duree">Durée de démembrement (en années)</label>
								<div class="col-md-4">
						...
						<div class="form-group visibility_form">
							<label class="col-md-4 control-label" for="date">Date d'enregistrement</label>	
							<div class="col-md-4">
							<?php
							if (!isMobile())
							{
						...
						<div class="more_dt">
							...
							<div class="form-group visibility_form">
								<label class="col-md-4 control-label" for="prix">Prix de la part en plein propriété (frais compris)</label>
								 <div class="col-md-4">
									 <input id="prix" name="prix" type="number" min="1" step="any" placeholder="Prix d'achat de(s) part(s) €" class="form-control input-md">
								 </div>
							...
							<div class="form-group">
								<label class="col-md-4 control-label" for="marche">Marché ?<p class="help-block">Sélectionner un type de marché</p></label>
								<div class="col-md-4">
							...
							<!-- Text input-->
							<div class="form-group">
								<label class="col-md-4 control-label" for="transaction">Transaction effectuée ?</label>	
								<div class="col-md-4">
							...
							<div class="more_info">
								<div class="form-group">
									<label class="col-md-4 control-label" for="informations" id="preci">Une précision ?</label>	
									<div class="col-md-4">
						...
						<div class="modal-footer">
							<div class="form-group">
								<div >
									...
									<button id="button2id" name="button2id" value="addTransaction" class="btn-add-scpi">Ajouter au portefeuille</button>
