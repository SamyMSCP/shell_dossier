...
<div class="container-fluid">
    <table class="t-visu">
        ...
        <tr>
            ...
            <th class="text-center">Donneur D'Ordres
            ...
            <th class="text-center">Mois prévisonnel<br>de validation</th>
            ...
            <th class="text-center">Prix part</th>
        ...
        <tr v-for="el in list" v-if="">
            ...
            <td class="text-center" v-if="el.type_pro=='Pleine propriété'"> PP </td>
            ...
            <td class="text-center">{{(el.prix_part).toLocaleString("fr", {style: "currency", currency: "EUR"})}} </td>
            <td class="text-center">{{(el.montant_investissement).toLocaleString("fr", {style: "currency", currency: "EUR"})}} </td>
