...
<div class="container-fluid">
    <table class="t-visu">
        ...
        <tr>
            ...
            <th class="text-center">Type de propriété</th>
            ...
            <th class="text-center">Clé de repartition</th>
        ...
        <tr v-for="el in list" v-if="">
            ...
            <td class="text-center"> {{el.type_pro}} </td>
            ...
            <td class="text-center" v-if="el.type_pro == 'Usufruit'">{{ 100 - el.cle_repartition }} </td>
            <td class="text-center" v-else-if="el.type_pro == 'Pleine propriété'"> 100 </td>
            <td class="text-center" v-else>{{ el.cle_repartition }} </td>
            <td class="text-center" v-if="el.type_pro == 'Usufruit'">{{(el.prix_part*(100 - el.cle_repartition)*el.nbr_part/100).toLocaleString("fr", {style: "currency", currency: "EUR"})}} </td>
            <td class="text-center" v-else>{{(el.montant_investissement).toLocaleString("fr", {style: "currency", currency: "EUR"})}} </td>
