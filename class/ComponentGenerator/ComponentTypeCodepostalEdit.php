...
class ComponentTypeCodepostalEdit extends ComponentGenerator {

	protected static $_dependances = [];
	protected static $_componentName = "component-type-codepostal-edit";
	...
	protected static function getTemplate($class, $config) {
		...
		$rt .= "<input type='text' :list='list' v-model='data.value'  placeholder='code postal'/>";
		$rt .= "
