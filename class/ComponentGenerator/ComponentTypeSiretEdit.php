...
class ComponentTypeSiretEdit extends ComponentGenerator {

	protected static $_dependances = [];
	protected static $_componentName = "component-type-siret-edit";
	...
	protected static function getTemplate($class, $config) {
		...
		$rt .= "<input type='text' maxlength='14' v-model='data.value' :placeholder='placeholder'/>";
		$rt .= "
