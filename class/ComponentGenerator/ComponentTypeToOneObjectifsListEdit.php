...
class ComponentTypeToOneObjectifsListEdit extends ComponentGenerator {

	protected static $_dependances = [];
	protected static $_componentName = "component-type-to-one-objectifs-list-edit";
	...
	protected static function getTemplate($class, $config) {
		...
		foreach (ObjectifsList2::getAll() as $elm)
			$rt .= "<option value='" . $elm->getId() . "'>" . $elm->getName()->get() . "</option>";
		$rt .= "</select>";
		$rt .= "
