...
class ComponentTypeNafEdit extends ComponentGenerator {

	protected static $_dependances = [
		"ComponentNafHelper" => ["noname" => []]
	];
	protected static $_componentName = "component-type-naf-edit";
	...
	protected static function getTemplate($class, $config) {
		...
		$rt .= "
			<input type='text' maxlength='6' v-model='data.value' placeholder='code NAF' />
		";
		$rt .= "
