...
class ComponentTypeUintEdit extends ComponentGenerator {

	protected static $_dependances = [];
	protected static $_componentName = "component-type-uint-edit";
	...
	protected static function getTemplate($class, $config) {
		...
		$rt .= "<input type='number' min='0' v-model='data.value' :placeholder='placeholder'/>";
		$rt .= "
