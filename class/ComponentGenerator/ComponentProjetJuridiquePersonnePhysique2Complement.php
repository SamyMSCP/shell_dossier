...
class ComponentProjetJuridiquePersonnePhysique2Complement extends ComponentGenerator {

	protected static $_dependances = [
		"ComponentInputCheckboxMscpi" => ["noname" => []]
	];
	protected static $_componentName = "component-projet-juridiquepersonnephysique2-complement";
	...
	protected static function getTemplate($class, $config) {
		...
		$rt .= "
			<component-project-mini-progress-bar-noname position='5'  :size='getSize'> </component-project-mini-progress-bar-noname>
				...
				'$componentName',
				{
					...
					watch: {
						...
						statut_parcour_client: function(val) {
							if (this.listPersonnePhysique == null)
								return ;
							if (val == 'JuridiquePersonnePhysique2Complement' && this.listPersonnePhysique.length >= 2) {
					...
					/*
						...
						*/
						...
						if (this.selectedProjet.statut_parcour_client.value == 'JuridiquePersonnePhysique2Complement' && this.listPersonnePhysique != null && this.listPersonnePhysique.length >= 2)
							this.\$store.commit('set_selected_PersonnePhysique', this.listPersonnePhysique[1]);
					}
				}
			);
