...
class ComponentTypeFloatEdit extends ComponentGenerator {

	protected static $_dependances = [];
	protected static $_componentName = "component-type-float-edit";
	...
	protected static function getTemplate($class, $config) {
		...
		$rt .= "<input type='number' step='0.01' min='0' v-model='data.value' />";
		$rt .= "
