...
class ComponentTypeTypeVoieEdit extends ComponentGenerator {

	protected static $_dependances = [];
	protected static $_componentName = "component-type-type-voie-edit";
	...
	protected static function getTemplate($class, $config) {
		...
		$rt .="<select v-model='data.value'>";
			...
			$rt .= "<option value='rue'>rue</option>";
			foreach (TypeAdresse::$_type_voie as $key => $elm) {
				$rt .= "<option value='$elm'>$elm</option>";
			}
		$rt .= "</select>";
		$rt .= "
