...
class ComponentProfilInvestisseurRisque extends ComponentGenerator {

	protected static $_dependances = [
		"ComponentInputCheckboxMscpi" => ["noname" => []]
	];
	protected static $_componentName = "component-profil-investisseur-risque";
	...
	protected static function getTemplate($class, $config) {
		...
		$niveau_risque = ProfilInvestisseur2::getComponentConfigured('niveau_risque', [':tooltips' => "getTooltips", "class" => "big"]);

		$rt .= "
			<component-project-mini-progress-bar-noname position='1' size='9'> </component-project-mini-progress-bar-noname>
				...
				'$componentName',
				{
					computed: {
						...
						getTitle: function(val) {
							return ('QUEL NIVEAU DE RISQUE ACCEPTEZ-VOUS ?');
						},
						getTooltips: function() {
							return ([
								{
									title: \"Aucune prise de risque\",
									content: \"Je n'accepte pas de perte en capital\"
								},
								{
									title: \"Une prise de risque limitée\",
									content: \"J'accepte une baisse au plus de 10% de la valeur de mon capital\"
								},
								{
									title: \"Une prise de risque modérée\",
									content: \"J'accepte une baisse au plus de 20% de la valeur de mon capital\"
								},
								{
									title: \"Une prise de risque importante\",
									content: \"J'accepte une baisse au plus de 30% de la valeur de mon capital\"
								}
