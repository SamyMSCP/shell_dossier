...
class ComponentTypeEnumSelectEdit extends ComponentGenerator {

	protected static $_dependances = [];
	protected static $_componentName = "component-type-enum-select-edit";
	...
	protected static function getTemplate($class, $config) {
		...
		$rt .="<select v-model='data.value'>";
			$rt .= "<option v-for='(elm, key) in list' :value='elm'>{{ key }}</option>";
		$rt .= "</select>";
		$rt .= "
