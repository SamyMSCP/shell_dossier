...
class ComponentTypeEnumButtonEdit extends ComponentGenerator {

	protected static $_dependances = [];
	protected static $_componentName = "component-type-enum-button-edit";
	...
	protected static function getTemplate($class, $config) {
		...
		$rt .= " 
			<div class='new_style_container'>
				<div v-for='(obj, key) in list' class='in_container' :class='{selected: obj == data.value}' @click='setOne(obj)'>
					{{ key }}
				</div>
			</div>
		";
