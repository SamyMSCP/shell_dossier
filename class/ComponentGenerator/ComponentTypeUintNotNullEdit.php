...
class ComponentTypeUintNotNullEdit extends ComponentGenerator {

	protected static $_dependances = [];
	protected static $_componentName = "component-type-uint-not-null-edit";
	...
	protected static function getTemplate($class, $config) {
		...
		$rt .= "<input type='number' min='1' v-model='data.value' />";
		$rt .= "
