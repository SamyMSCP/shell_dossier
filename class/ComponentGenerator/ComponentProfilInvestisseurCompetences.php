...
class ComponentProfilInvestisseurCompetences extends ComponentGenerator {

	protected static $_dependances = [
		"ComponentInputCheckboxMscpi" => ["noname" => []]
	];
	protected static $_componentName = "component-profil-investisseur-competences";
	...
	protected static function getTemplate($class, $config) {
		...
		$competences_imobilieres = ProfilInvestisseur2::getComponentConfigured('competences_imobilieres');

		$rt .= "
			<component-project-mini-progress-bar-noname position='2' size='9'> </component-project-mini-progress-bar-noname>
			<div class='form_inline'>
				Possédez-vous des compétences et connaissances particulières dans le domaine de l'immobilier
			</div>
