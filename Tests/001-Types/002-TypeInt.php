...
if (!test("Importation de la classe", class_exists("TypeInt"), "La classe type ne semble pas exister"))
	return (false);

if (!test("Vérification de la validité de la classe methode verify()", TypeInt::verify() === true, "Le type de donnée TypeInt ne semble pas être valide"))
	return (false);
...
$type = new TypeInt($table, ["column" => "dataTest"]);
...
if (!test("Test d'erreur : true", $type->set(true) === false, "Insérer une valeur booléenne à un int ?? => KO"))
	return (false);
