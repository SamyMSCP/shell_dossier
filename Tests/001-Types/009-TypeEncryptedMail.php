...
if (!test("Importation de la classe", class_exists("TypeEncryptedMail"), "La classe type ne semble pas exister"))
	return (false);

if (!test("Vérification de la validité de la classe methode verify()", TypeEncryptedMail::verify() === true, "Le type de donnée TypeEncryptedMail ne semble pas être valide"))
	return (false);
...
$type = new TypeEncryptedMail($table, ["column" => "dataTest"]);
