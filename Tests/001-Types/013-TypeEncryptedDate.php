...
if (!test("Importation de la classe", class_exists("TypeEncryptedDate"), "La classe type ne semble pas exister"))
	return (false);

if (!test("Vérification de la validité de la classe methode verify()", TypeEncryptedDate::verify() === true, "Le type de donnée TypeEncryptedDate ne semble pas être valide"))
	return (false);
...
$type = new TypeEncryptedDate($table, ["column" => "dataTest"]);
