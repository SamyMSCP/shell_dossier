...
if (!test("Importation de la classe", class_exists("TypeEncryptedPhone"), "La classe type ne semble pas exister"))
	return (false);

if (!test("Vérification de la validité de la classe methode verify()", TypeEncryptedPhone::verify() === true, "Le type de donnée TypeEncryptedPhone ne semble pas être valide"))
	return (false);
...
$type = new TypeEncryptedPhone($table, [
	"column" => [
		"num" => "num",
		"indicatif" => "indicatif"
	]
