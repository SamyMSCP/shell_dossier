...
<form method="POST" class="form-horizontal" id="tosendinfo">
	...
	<div class="contentSituation">
		<div class="blockSituation block2">
			<div class="titleBlockSituation">
				VOTRE SITUATION FISCALE : Impôt sur le revenu
			</div>
			<div class="contentBlockSituation">
				<div class="contenuOut">
					<div class="contenu">
						...
						<div class="form-group irDetail">
							<label class="labelForm control-label" for="">Votre impôt au titre de l’année précédente (en €)</label>
							<div class="inputForm">
								<input value="<?=(isset($this->SituationFiscale)) ? $this->SituationFiscale->getImpotAnneePrecedente() : "" ?>" id="impot_annee_precedente" name="impot_annee_precedente" class="form-control" placeholder="" type="number"step="any" min="0">
								<img id="impot_annee_precedenteValide" src="<?=$this->getPath()?>img/CP-Valide.svg" alt=""/>
							</div>
						</div>
						...
						<div class="form-group irDetail">
							...
							<div class="arrSelect inputForm">
								...
								<select id="taux_marginal_imposition" name="id_tranche_impot" class="form-control">
									<?php
									//$tmp = (isset($this->SituationFiscale)) ? $this->SituationFiscale->getPays() : "France";
	...
	<div class="contentSituation">
		<div class="blockSituation block3">
			<div class="titleBlockSituation">
				VOTRE SITUATION FISCALE : Impôt sur la fortune (ISF)
			</div>
			<div class="contentBlockSituation">
				<div class="contenuOut">
					<div class="contenu">
						...
						<div class="form-group">
							<label class="labelForm control-label" for="other_money">Êtes-vous assujetti(e) à l’impôt sur la fortune ?</label>
							<div class="inputForm" style="margin-top: -6px;"> 
						...
						<div class="form-group isfDetail">
							...
							<div class="arrSelect inputForm">
								...
								<select id="tranche_isf" name="id_tranche_impot_fortune" class="form-control">
									<?php
									//$tmp = (isset($this->SituationFiscale)) ? $this->SituationFiscale->getPays() : "France";
