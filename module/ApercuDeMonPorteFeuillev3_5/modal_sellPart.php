		...
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<div class="modal-body">
					...
					<div class="row text-center"><input id="prix_sell" name="prix_part_sell" min="1" type="number" value="1" step="any" placeholder="Prix de vente de(s) part(s) €" class="prix_part_sell"> euros.
					</div>
				</div>
