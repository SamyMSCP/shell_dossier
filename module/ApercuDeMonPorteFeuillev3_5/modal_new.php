	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content" style="background-color:#EBEBEB">
			<div class="modal-header" style="margin-top: 10px;">
				...
				<h4 class="modal-title">AJOUTER UNE SCPI QUE JE DÉTIENS DÉJÀ</h4>
			</div>
...
<?php foreach(Transaction::getTypeProLst() as $tr) : ?>
...
<?php foreach(Transaction::getTypeDemembrementLst() as $tr) : ?>
										<option value="<?= $tr ?>"><?= $tr ?></option>
<?php endforeach; ?>
									</select>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-4">
									<select id="marche" name="marche" class="form-control">
										<option value="-">-</option>
<?php foreach(Transaction::getMarcheLst() as $tr) : ?>
										<option value="<?= $tr ?>"><?= $tr ?></option>
<?php endforeach; ?>
									</select>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-4">
									<input id="montant_credit" name="montant_credit" type="number" class="form-control" value=""  min="0" step="1">
								</div>
							</div>
							<div class="form-group">
						...
						<div class="modal-footer">
							<div class="form-group">
								<label class="col-md-6 control-label" for="button2idscpi">Une question ? Contactez nous au 0 805 696 022 (appel gratuit depuis un fixe).</label>
								<div class="col-md-6">
									<input type="hidden" name="isMore" id="isMore" value="0" />
									<button id="button2idscpi" name="button2id" value="addTransaction" class="btn-add-scpi">Ajouter à mon portefeuille</button>
